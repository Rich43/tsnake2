...
MPForm.Cls
   ...
   For p = TailLength To 1 Step -1
        ...
        If Not p = 1 Then
            ...
            BitBlt MPForm.hDC, SPos(p - 1).Left, SPos(p - 1).Top, 10, 10, TailMask.hDC, 0, 0, SRCAND
            BitBlt MPForm.hDC, SPos(p - 1).Left, SPos(p - 1).Top, 10, 10, TailSprite.hDC, 0, 0, SRCPAINT
        Else

                If Direction = "Down" Then
                    BitBlt MPForm.hDC, SPos(0).Left, SPos(0).Top, 10, 12, HeadMask.hDC, 0, 0, SRCAND
                    BitBlt MPForm.hDC, SPos(0).Left, SPos(0).Top, 10, 12, HeadSprite.hDC, 0, 0, SRCPAINT
                End If
                
                If Direction = "Up" Then
                    BitBlt MPForm.hDC, SPos(0).Left, SPos(0).Top - 2, 10, 12, HeadMask.hDC, 0, 12, SRCAND
                    BitBlt MPForm.hDC, SPos(0).Left, SPos(0).Top - 2, 10, 12, HeadSprite.hDC, 0, 12, SRCPAINT
                End If

                If Direction = "Left" Then
                    BitBlt MPForm.hDC, SPos(0).Left - 2, SPos(0).Top, 12, 10, HeadMask.hDC, 10, 0, SRCAND
                    BitBlt MPForm.hDC, SPos(0).Left - 2, SPos(0).Top, 12, 10, HeadSprite.hDC, 10, 0, SRCPAINT
                End If

                If Direction = "Right" Then
                    BitBlt MPForm.hDC, SPos(0).Left, SPos(0).Top, 12, 10, HeadMask.hDC, 10, 10, SRCAND
                    BitBlt MPForm.hDC, SPos(0).Left, SPos(0).Top, 12, 10, HeadSprite.hDC, 10, 10, SRCPAINT
                End If

        End If

            BitBlt MPForm.hDC, SPos(TailLength).Left, SPos(TailLength).Top, 10, 10, EndMask.hDC, 0, 0, SRCAND
            BitBlt MPForm.hDC, SPos(TailLength).Left, SPos(TailLength).Top, 10, 10, EndSprite.hDC, 0, 0, SRCPAINT
            
                SPos(p).Left = SPos(p - 1).Left
                SPos(p).Top = SPos(p - 1).Top
   Next

        BitBlt MPForm.hDC, FoodLeft, FoodTop, 10, 10, FoodMask.hDC, 0, 0, SRCAND
        BitBlt MPForm.hDC, FoodLeft, FoodTop, 10, 10, FoodSprite.hDC, 0, 0, SRCPAINT

    For J = 1 To WallCount

        BitBlt MPForm.hDC, WPos(J).Left, WPos(J).Top, 10, 10, WallMask.hDC, 0, 0, SRCAND
        BitBlt MPForm.hDC, WPos(J).Left, WPos(J).Top, 10, 10, WallSprite.hDC, 0, 0, SRCPAINT

    Next

If GemYN = True Then
            BitBlt MPForm.hDC, GemLeft, GemTop, 9, 9, GemMask.hDC, 0, 0, SRCAND
            BitBlt MPForm.hDC, GemLeft, GemTop, 9, 9, GemSprite.hDC, 0, 0, SRCPAINT
End If
...
'Boarder collision
        ...
        If TopPos > MPForm.ScaleHeight - 10 Then
            TopPos = 0
            Direction = "Down"
        End If
        ...
        If LeftPos > MPForm.ScaleWidth - 10 Then
            LeftPos = 0
            Direction = "Right"
        End If
...
Function LoadGFX()
    ...
    MPForm.Picture = LoadPicture("GFX\Backgrounds\Default.gif")
